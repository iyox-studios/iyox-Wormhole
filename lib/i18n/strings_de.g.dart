...
class _TranslationsPagesSendDe extends TranslationsPagesSendEn {
	...
	@override String get abort_transfer_yes => 'Ja';
	@override String get abort_transfer_no => 'Nein';
	@override String get zip_failed => 'Beim Erstellen des ZIP-Archivs ist ein Fehler aufgetreten';
	@override String get clipboard_copied => 'Code in die Zwischenablage kopiert';
	@override String get status_waiting => 'Warten auf Empfänger';
	@override String get status_transferring => 'Datei wird übertragen';
	@override String connection_info({required Object type}) => 'Übertragung über: ${type}';
	@override String get status_initializing => 'Übertragung wird initialisiert';
	@override String get status_zipping => 'Zip-Datei wird erstellt';
	@override String status_zipping_progress({required Object progress}) => 'Zip-Datei wird erstellt: ${progress}';
	@override String get status_starting_transfer => 'Übertragung wird gestartet';
}
...
class _TranslationsPagesReceiveDe extends TranslationsPagesReceiveEn {
	...
	@override String get status_connecting => 'Verbindung herstellen...';
	@override String get status_transferring => 'Datei wird übertragen';
	@override String status_finished({required Object name}) => 'Datei erhalten: ${name}';
}
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'pages.send.abort_transfer_yes': return 'Ja';
			case 'pages.send.abort_transfer_no': return 'Nein';
			case 'pages.send.zip_failed': return 'Beim Erstellen des ZIP-Archivs ist ein Fehler aufgetreten';
			case 'pages.send.clipboard_copied': return 'Code in die Zwischenablage kopiert';
			case 'pages.send.status_waiting': return 'Warten auf Empfänger';
			case 'pages.send.status_transferring': return 'Datei wird übertragen';
			case 'pages.send.connection_info': return ({required Object type}) => 'Übertragung über: ${type}';
			case 'pages.send.status_initializing': return 'Übertragung wird initialisiert';
			case 'pages.send.status_zipping': return 'Zip-Datei wird erstellt';
			case 'pages.send.status_zipping_progress': return ({required Object progress}) => 'Zip-Datei wird erstellt: ${progress}';
			case 'pages.send.status_starting_transfer': return 'Übertragung wird gestartet';
			case 'pages.receive.code_input_hint': return 'Code eingeben';
			case 'pages.receive.receive_button': return 'Datei erhalten';
			case 'pages.receive.status_connecting': return 'Verbindung herstellen...';
			case 'pages.receive.status_transferring': return 'Datei wird übertragen';
			case 'pages.receive.status_finished': return ({required Object name}) => 'Datei erhalten: ${name}';
