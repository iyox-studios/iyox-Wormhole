...
class TranslationsPagesEn {
  ...
  late final TranslationsPagesReceiveEn receive =
      TranslationsPagesReceiveEn.internal(_root);
  late final TranslationsPagesSettingsEn settings =
      TranslationsPagesSettingsEn.internal(_root);
}
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'pages.receive.status_finished':
        return ({required Object name}) => 'Received file: ${name}';
      ...
      case 'pages.settings.dynamic_color_subtitle':
        return 'Use system colors (Android 12+)';
